...
export default function HeroSection() {
  ...
  return (
    <section className="relative h-screen flex items-center justify-center overflow-hidden pt-16">
      ...
      {/* Watermark solution - Simula borda natural do vídeo - responsivo */}
      <div className="absolute bottom-0 right-0 w-1/2 sm:w-[500px] md:w-[600px] lg:w-[700px] h-[60px] video-corner-shadow z-[5] pointer-events-none"></div>
